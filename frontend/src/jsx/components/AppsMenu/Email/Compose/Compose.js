              ...
              <div className="email-right-box ml-0 ml-sm-4 ml-sm-0">
                <div className="toolbar mb-4" role="toolbar">
                  ...
                  <Dropdown className="btn-group mb-1">
                    <Dropdown.Toggle
                      type="button"
                      className="btn btn-primary i-false light dropdown-toggle px-3 ml-1"
                  ...
                  <Dropdown className="btn-group mb-1">
                    <Dropdown.Toggle
                      className="btn btn-primaryi-false light dropdown-toggle px-3 ml-1"
                      data-toggle="dropdown"
                    >
                  ...
                  <Dropdown className="btn-group mb-1">
                    <Dropdown.Toggle
                      type="button"
                      className="btn btn-primary i-false light dropdown-toggle v ml-1"
                      data-toggle="dropdown"
                    >
